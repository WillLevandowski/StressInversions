...
%                                                                         %
%*************************************************************************%
function stress = linear_stress_inversion_oneVertical(strike,dip,rake)
...
% aa=[a_vector_1 a_vector_2 a_vector_3];
% pred_vec=A*stress_vector;
% l=length(a_vector_1);
% pred_cos=[pred_vec(1:l) pred_vec(l+1:2*l) pred_vec(2*l+1:3*l)];
% d=(pred_cos-aa);
% dd=d.^2;
% ddd=sum(dd,2);
% dddd=sqrt(ddd);
